...
<?php endforeach;?>
<p class="">Do you want to leave? We're sorry to hear that, <a href="#" onclick="confirmation()">clik here to delete your account.</a></p>
<p id="confirmation" style="display:none;"> Are you sure you want to delete your account? <a href="<?php echo URL?>user/delete">Yes</a>, <a href="#" id="no">No</a></p>
